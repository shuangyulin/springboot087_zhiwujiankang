...
public class ZhenguizhiwujianchadengjiEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public ZhenguizhiwujianchadengjiEntity() {
		
	}
	
	public ZhenguizhiwujianchadengjiEntity(T t) {
		try {
